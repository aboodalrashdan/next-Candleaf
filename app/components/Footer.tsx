      ...
      <div className={styles.container}>
        ...
        <div className={styles.linksSection}>
          <div className={styles.column}>
            ...
            <Link href="#"><p>New season</p></Link>
            <Link href="#"><p>Most searched</p></Link>
            <Link href="#"><p>Most selled</p></Link>
          </div>
          <div className={styles.column}>
            <p className={styles.txt}>Info</p>
            <Link href="#"><p>Contact Us</p></Link>
            <Link href="#"><p>Privacy Policies</p></Link>
